...
def is_exist(data):
    ...
    return df.iloc[tmp].reset_index(drop=True)
...
if __name__ == "__main__":
    path = rf"C:\Users\Playdata\Desktop\insta\crawl\EDA\tmp\ttt\data_ver4.csv"
