...
# 로그인 버튼 찾아서 클릭
button_login_window = driver.find_element(By.CSS_SELECTOR, '#__PWS_ROOT__ > div:nth-child(1) > div > div > div > div:nth-child(2) > div.Jea._he.b8T.gjz.zI7.iyn.Hsu > div.Jea.l7T.zI7.iyn.Hsu > div:nth-child(2) > button')
...
# 이메일, 비밀번호 폼 찾기
input_email = driver.find_element(By.XPATH, '/html/body/div[1]/div[1]/div/div/div/div[1]/div[2]/div[2]/div/div/div/div/div/div/div/div[4]/form/div[1]/fieldset/span/div/input')
input_password = driver.find_element(By.XPATH, '/html/body/div[1]/div[1]/div/div/div/div[1]/div[2]/div[2]/div/div/div/div/div/div/div/div[4]/form/div[2]/fieldset/span/div/input')
...
# 로그인 버튼 누르기
button_login = driver.find_element(By.XPATH, '/html/body/div[1]/div[1]/div/div/div/div[1]/div[2]/div[2]/div/div/div/div/div/div/div/div[4]/form/div[5]/button')
button_login.click()
...
for search_word in conf.search_words:
    ...
    while True:
        ...
        try:
            # get images
            images = driver.find_elements(By.XPATH, "//img[@srcset]")
