...
df = pd.read_csv(r'C:\Memoticon\data\006_drop_by_ratio.csv')
...
df_filtered_copy.loc[df_filtered_copy['hashtag'] == "X", 'hashtag'] = ""

# 결과 확인
df_filtered_copy.to_csv('./007_drop_by_ratio.csv', index=False)
